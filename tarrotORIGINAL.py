...
Nine_of_Wands = """The Nine of Wands comes as a sign that even in the face of adversity, you stand tall and strong. You may be on the edge of exhaustion, but you are resilient, persistent, and ready to do what it takes to get to the finish line.
...
Ace_of_Cups = """With the Ace of Cups, Divine love and compassion are pouring through you. You are a vessel for deep, spiritual love from the Universe, and you can’t help but let that love flow through you and into the world. You receive love, you give love, you ARE love. Your heart overflows.
...
Three_of_Cups = """The Three of Cups is a card of celebration, friendship, sisterhood, and creative collaborations. Your friends and family are here to support you and lift you up to even higher levels of success. Celebrate with them and enjoy their camaraderie.
...
Knight_of_Swords = """As with all Knights of the Tarot deck, the Knight of Swords is a man (or woman) on a mission – once he has his mind set on something, nothing is stopping him. And as a Swords card, this Knight actively uses the power of his intellect to achieve his goals.
...
King_of_Swords = """The King of Swords is a symbol of intellectual power and authority and has the courage and intellect to achieve all that he desires. When this card appears in a Tarot reading, you are in your power, ruling from a place of authority and respect. You stand firm in your truth and express yourself with deep conviction. As a result, others pay attention to what you have to say.
...
two_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/2-of-pentacles.jpg')
three_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/3-of-pentacles.jpg')
three_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/3-of-pentacles.jpg')
four_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/4-of-pentacles.jpg')
four_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/4-of-swords.jpg')
five_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/5-of-pentacles.jpg')
five_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/5-of-swords.jpg')
six_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/6-of-pentacles.jpg')
six_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/6-of-swords.jpg')
seven_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/7-of-pentacles.jpg')
seven_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/7-of-swords.jpg')
eight_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/8-of-pentacles.jpg')
eight_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/8-of-swords.jpg')
nine_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/9-of-pentacles.jpg')
nine_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/9-of-swords.jpg')
ten_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/10-of-swords.jpg')
ten_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/10-of-pentacles.jpg')
ace_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/ace-of-cups.jpg')
ace_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/ace-of-pentacles.jpg')
ace_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/ace-of-swords-1.jpg')
ace_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/ace-of-wands.jpg')
chariot = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/chariot.jpg')
death = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/death.jpg')
devil = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/devil.jpg')
eight_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/eight-of-cups.jpg')
eight_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/eight-of-wands.jpg')
emperor = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/emperor.jpg')
empress = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/empress.jpg')
five_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/five-of-cups.jpg')
five_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/five-of-wands.jpg')
fool = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/fool.jpg')
four_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/four-of-cups.jpg')
four_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/four-of-wands.jpg')
hanged_man = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/hanged-man.jpg')
hermit = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/hermit.jpg')
hierophant = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/hierophant.jpg')
high_priestess = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/high-priestess.jpg')
judgement = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/judgement.jpg')
justice = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/justice.jpg')
king_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/king-of-cups.jpg')
king_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/king-of-pentacles.jpg')
king_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/king-of-swords.jpg')
king_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/king-of-wands.jpg')
knight_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/kinght-of-pentacles.jpg')
knight_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/knight-of-cups.jpg')
knight_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/knight-of-swords.jpg')
knight_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/knight-of-wands.jpg')
lovers = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/lovers.jpg')
magician = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/magician.jpg')
moon = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/moon.jpg')
nine_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/nine-of-cups.jpg')
nine_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/nine-of-wands.jpg')
page_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/page-of-cups.jpg')
page_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/page-of-pentacles.jpg')
page_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/page-of-swords.jpg')
page_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/page-of-wands.jpg')
queen_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/queen-of-cups.jpg')
queen_of_pentacles = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/queen-of-pentacles.jpg')
queen_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/queen-of-swords.jpg')
queen_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/queen-of-wands.jpg')
seven_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/seven-of-cups.jpg')
seven_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/seven-of-wands.jpg')
six_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/six-of-cups.jpg')
six_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/six-of-wands.jpg')
star = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/star.jpg')
strength = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/strength.jpg')
sun = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/sun.jpg')
temperance = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/temperance.jpg')
ten_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/ten-of-cups.jpg')
ten_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/ten-of-wands.jpg')
three_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/three-of-cups.jpg')
three_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/three-of-wands.jpg')
tower = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/tower.jpg')
two_of_cups = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/two-of-cups.jpg')
two_of_swords = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/two-of-swords.jpg')
two_of_wands = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/two-of-wands.jpg')
wheel_of_fortune = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/wheel-of-fortune.jpg')
world = Image.open(r'/home/otundetchagala/PycharmProjects/pythonProject/projects/TarrotDeck/world.jpg')
...
def call_card():
    value = random.choice(list(final_dict2.values()))
    if value == 'The Fool':
        fool.show()
        print('The Fool')
        print('==========================')
        print(the_fool)
    elif value == 'The Magician':
        magician.show()
        print('The Magician')
        print('==========================')
        print(the_magician)
    elif value == 'The High Priestess':
        high_priestess.show()
        print('The High Priestess')
        print('==========================')
        print(The_High_Priestess)
    elif value == 'The Empress':
        empress.show()
        print('The Empress')
        print('==========================')
        print(The_Empress)
    elif value == 'The Emperor':
        emperor.show()
        print('The Emperor')
        print('==========================')
        print(The_Emperor)
    elif value == 'The Hierophant':
        hierophant.show()
        print('The Hierophant')
        print('==========================')
        print(The_Hierophant)
    elif value == 'The Lovers':
        lovers.show()
        print('The Lovers')
        print('==========================')
        print(The_Lovers)
    elif value == 'The Chariot':
        chariot.show()
        print('The Chariot')
        print('==========================')
        print(The_Chariot)
    elif value == 'Justice† or Strength‡':
        justice.show()
        print('Justice† or Strength‡')
        print('==========================')
        print(Justice_or_Strengt)
    elif value == 'The Hermit':
        hermit.show()
        print('The Hermit')
        print('==========================')
        print(The_Hermit)
    elif value == 'Wheel of Fortune':
        wheel_of_fortune.show()
        print('Wheel of Fortune')
        print('==========================')
        print(Wheel_of_Fortune)
    elif value == 'Strength† or Justice‡':
        strength.show()
        print('Strength† or Justice‡')
        print('==========================')
        print(Strength_or_Justice)
    elif value == 'The Hanged Man':
        hanged_man.show()
        print('The Hanged Man')
        print('==========================')
        print(The_Hanged_Man)
    elif value == 'The Magician':
        magician.show()
        print('The Magician')
        print('==========================')
        ...
        print('==========================')
        print(Death)
    elif value == 'Temperance':
        temperance.show()
        print('Temperance')
        print('==========================')
        print(Temperance)
    elif value == 'The Devil':
        devil.show()
        print('The Devil')
        print('==========================')
        print(The_Devil)
    elif value == 'The Tower':
        tower.show()
        print('The Tower')
        print('==========================')
        print(The_Tower)
        ...
        print('==========================')
        print(The_Sun)
    elif value == 'Judgement':
        judgement.show()
        print('Judgement')
        print('==========================')
        print(Judgement)
    elif value == 'The World':
        world.show()
        print('The World')
        print('==========================')
        print(The_World)
    elif value == 'Ace of Wands':
        ace_of_wands.show()
        print('Ace of Wands')
        print('==========================')
        print(Ace_of_Wands)
    elif value == 'Two of Wands':
        two_of_wands.show()
        print('Two of Wands')
        print('==========================')
        print(Two_of_Wands)
    elif value == 'Three of Wands':
        three_of_wands.show()
        print('Three of Wands')
        print('==========================')
        print(Three_of_Wands)
    elif value == 'Four of Wands':
        four_of_wands.show()
        print('Four of Wands')
        print('==========================')
        print(Four_of_Wands)
    elif value == 'Five of Wands':
        five_of_wands.show()
        print('Five of Wands')
        print('==========================')
        print(Five_of_Wands)
    elif value == 'Six of Wands':
        six_of_wands.show()
        print('Six of Wands')
        print('==========================')
        print(Six_of_Wands)
    elif value == 'Seven of Wands':
        seven_of_wands.show()
        print('Seven of Wands')
        print('==========================')
        print(Seven_of_Wands)
    elif value == 'Eight of Wands':
        eight_of_wands.show()
        print('Eight of Wands')
        print('==========================')
        print(Eight_of_Wands)
    elif value == 'Nine of Wands':
        nine_of_wands.show()
        print('Nine of Wands')
        print('==========================')
        print(Nine_of_Wands)
    elif value == 'Ten of Wands':
        ten_of_wands.show()
        print('Ten of Wands')
        print('==========================')
        print(Ten_of_Wands)
    elif value == 'Page of Wands':
        page_of_wands.show()
        print('Page of Wands')
        print('==========================')
        print(Page_of_Wands)
    elif value == 'Knight of Wands':
        knight_of_wands.show()
        print('Knight of Wands')
        print('==========================')
        print(Knight_of_Wands)
    elif value == 'Queen of Wands':
        queen_of_wands.show()
        print('Queen of Wands')
        print('==========================')
        print(Queen_of_Wands)
    elif value == 'King of Wands':
        king_of_wands.show()
        print('King of Wands')
        print('==========================')
        print(King_of_Wands)
    elif value == 'Ace of Cups':
        ace_of_cups.show()
        print('Ace of Cups')
        print('==========================')
        print(Ace_of_Cups)
    elif value == 'Two of Cups':
        two_of_cups.show()
        print('Two of Cups')
        print('==========================')
        print(Two_of_Cups)
    elif value == 'Three of Cups':
        three_of_cups.show()
        print('Three of Cups')
        print('==========================')
        print(Three_of_Cups)
    elif value == 'Four of Cups':
        four_of_cups.show()
        print('Four of Cups')
        print('==========================')
        print(Four_of_Cups)
    elif value == 'Five of Cups':
        five_of_cups.show()
        print('Five of Cups')
        print('==========================')
        print(Five_of_Cups)
    elif value == 'Six of Cups':
        six_of_cups.show()
        print('Six of Cups')
        print('==========================')
        print(Six_of_Cups)
    elif value == 'Seven of Cups':
        seven_of_cups.show()
        print('Seven of Cups')
        print('==========================')
        print(Seven_of_Cups)
    elif value == 'Eight of Cups':
        eight_of_cups.show()
        print('Eight of Cups')
        print('==========================')
        print(Eight_of_Cups)
    elif value == 'Nine of Cups':
        nine_of_cups.show()
        print('Nine of Cups')
        print('==========================')
        print(Nine_of_Cups)
    elif value == 'Ten of Cups':
        ten_of_cups.show()
        print('Ten of Cups')
        print('==========================')
        print(Ten_of_Cups)
    elif value == 'Page of Cups':
        page_of_cups.show()
        print('Page of Cups')
        print('==========================')
        print(Page_of_Cups)
    elif value == 'Knight of Cups':
        knight_of_cups.show()
        print('Knight of Cups')
        print('==========================')
        print(Knight_of_Cups)
    elif value == 'Queen of Cups':
        queen_of_cups.show()
        print('Queen of Cups')
        print('==========================')
        print(Queen_of_Cups)
    elif value == 'King of Cups':
        king_of_cups.show()
        print('King of Cups')
        print('==========================')
        print(King_of_Cups)
    elif value == 'Ace of Swords':
        ace_of_swords.show()
        print('Ace of Swords')
        print('==========================')
        print(Ace_of_Swords)
    elif value == 'Two of Swords':
        two_of_swords.show()
        print('Two of Swords')
        print('==========================')
        print(Two_of_Swords)
    elif value == 'Three of Swords':
        three_of_swords.show()
        print('Three of Swords')
        print('==========================')
        print(Three_of_Swords)
    elif value == 'Four of Swords':
        four_of_swords.show()
        print('Four of Swords')
        print('==========================')
        print(Four_of_Swords)
    elif value == 'Five of Swords':
        five_of_swords.show()
        print('Five of Swords')
        print('==========================')
        print(Five_of_Swords)
    elif value == 'Six of Swords':
        six_of_swords.show()
        print('Six of Swords')
        print('==========================')
        print(Six_of_Swords)
    elif value == 'Seven of Swords':
        seven_of_swords.show()
        print('Seven of Swords')
        print('==========================')
        print(Seven_of_Swords)
    elif value == 'Eight of Swords':
        eight_of_swords.show()
        print('Eight of Swords')
        print('==========================')
        print(Eight_of_Swords)
    elif value == 'Nine of Swords':
        nine_of_swords.show()
        print('Nine of Swords')
        print('==========================')
        print(Nine_of_Swords)
    elif value == 'Ten of Swords':
        ten_of_swords.show()
        print('Ten of Swords')
        print('==========================')
        print(Ten_of_Swords)
    elif value == 'Page of Swords':
        page_of_swords.show()
        print('Page of Swords')
        print('==========================')
        print(Page_of_Swords)
    elif value == 'Knight of Swords':
        knight_of_swords.show()
        print('Knight of Swords')
        print('==========================')
        print(Knight_of_Swords)
    elif value == 'Queen of Swords':
        queen_of_swords.show()
        print('Queen of Swords')
        print('==========================')
        print(Queen_of_Swords)
    elif value == 'King of Swords':
        king_of_swords.show()
        print('King of Swords')
        print('==========================')
        print(King_of_Swords)
    elif value == 'Ace of Pentacles':
        ace_of_pentacles.show()
        print('Ace of Pentacles')
        print('==========================')
        print(Ace_of_Pentacles)
    elif value == 'Two of Pentacles':
        two_of_pentacles.show()
        print('Two of Pentacles')
        print('==========================')
        print(Two_of_Pentacles)
    elif value == 'Three of Pentacles':
        three_of_pentacles.show()
        print('Three of Pentacles')
        print('==========================')
        print(Three_of_Pentacles)
    elif value == 'Four of Pentacles':
        four_of_pentacles.show()
        print('Four of Pentacles')
        print('==========================')
        print(Four_of_Pentacles)
    elif value == 'Five of Pentacles':
        five_of_pentacles.show()
        print('Five of Pentacles')
        print('==========================')
        print(Five_of_Pentacles)
    elif value == 'Six of Pentacles':
        six_of_pentacles.show()
        print('Six of Pentacles')
        print('==========================')
        print(Six_of_Pentacles)
    elif value == 'Seven of Pentacles':
        seven_of_pentacles.show()
        print('Seven of Pentacles')
        print('==========================')
        print(Seven_of_Pentacles)
    elif value == 'Eight of Pentacles':
        eight_of_pentacles.show()
        print('Eight of Pentacles')
        print('==========================')
        print(Eight_of_Pentacles)
    elif value == 'Nine of Pentacles':
        nine_of_pentacles.show()
        print('Nine of Pentacles')
        print('==========================')
        print(Nine_of_Pentacles)
    elif value == 'Ten of Pentacles':
        ten_of_pentacles.show()
        print('Ten of Pentacles')
        print('==========================')
        print(Ten_of_Pentacles)
    elif value == 'Page of Pentacles':
        page_of_pentacles.show()
        print('Page of Pentacles')
        print('==========================')
        print(Page_of_Pentacles)
    elif value == 'Knight of Pentacles':
        knight_of_pentacles.show()
        print('Knight of Pentacles')
        print('==========================')
        print(Knight_of_Pentacles)
    elif value == 'Queen of Pentacles':
        queen_of_pentacles.show()
        print('Queen of Pentacles')
        print('==========================')
        print(Queen_of_Pentacles)
    elif value == 'King of Pentacles':
        king_of_pentacles.show()
        print('King of Pentacles')
        print('==========================')
        print(King_of_Pentacles)
